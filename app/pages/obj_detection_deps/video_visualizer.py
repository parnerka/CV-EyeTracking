# This file contains the code to visualize the detected object and gaze point in a video format
...
# function to visualize the detected object and the gaze point in a video format - for the video dataset
def visualize(data, video_loc, bb_size, sr, file_name):
    global bbsize
    bbsize = bb_size
    data['Object_BB'] = data['Object_BB'].apply(get_norm_coor)
    ...
    for i in stqdm(range(len(data)), desc='Generating Visualization'):
        ...
        object_coordinates = row['Object_BB']
...
# function to visualize the detected object and gaze point in a video format - for the screenshot dataset
